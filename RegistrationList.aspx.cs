...
namespace Portfolio1_1
{
    public partial class Admin : System.Web.UI.Page
    {
        ...
        {
            using (project6_1.StudentRegistrationAppDataClassesDataContext studentRegistrationAppDataClassesDataContext = new project6_1.StudentRegistrationAppDataClassesDataContext())
            {
        ...
        protected void OnRowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            using (project6_1.StudentRegistrationAppDataClassesDataContext studentRegistrationAppDataClassesDataContext = new project6_1.StudentRegistrationAppDataClassesDataContext())
            {
                project6_1.StudentRegistationAppTable studentRegistationAppTable = (from c in studentRegistrationAppDataClassesDataContext.StudentRegistationAppTables
