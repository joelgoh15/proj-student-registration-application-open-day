                    ...
                    <table id="idTableParticulars" class="classTableParticulars">
                        ...
                        <tr>
                            <td>
                                ...
                                <asp:LinqDataSource ID="InsertLinqDataSource" runat="server" ContextTypeName="project6_1.StudentRegistrationAppDataClassesDataContext" EnableInsert="True" EnableUpdate="True" EntityTypeName="" TableName="StudentRegistationAppTables">
                                </asp:LinqDataSource>
                            </td>    
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>
                                <div id="idDivLinkToAdminForm" class="classDivLinkToAdminForm">
                                    <asp:HyperLink ID="idHyperLinkBackToAdminForm" CssClass="CssClassHyperLinkBackToRegistrationForm" Font-Italic="true" Font-Underline="true" NavigateUrl="~/RegistrationList.aspx"  runat="server">View Registration List</asp:HyperLink>
                                </div>
                            </td>
                        </tr>
                        <tr>
